...
#of0_1 = pd.read_csv('/home/wirdze/python2/Branches/OF0Simulator/bin/PlotData/etx1_plots.csv')
#of0_2 = pd.read_csv('/home/wirdze/python2/Branches/OF0Simulator/bin/PlotData/etx2_plots.csv')

#of0_1 = pd.read_csv('/home/wirdze/python2/Branches/MrHoFSimulator/bin/PlotData/simple_topology_cte_rssi_changing_pdr/etx1_plots.csv')
#of0_2 = pd.read_csv('/home/wirdze/python2/Branches/MrHoFSimulator/bin/PlotData/simple_topology_cte_rssi_changing_pdr/etx2_plots.csv')

of0_1 = pd.read_csv('/home/wirdze/python2/Branches/MrHoFSimulator/bin/PlotData/simple_topology_varying_rssis/etx1_plots.csv')
of0_2 = pd.read_csv('/home/wirdze/python2/Branches/MrHoFSimulator/bin/PlotData/simple_topology_varying_rssis/etx2_plots.csv')
...
layout = go.Layout(
                title='MrHof Path Cost(ETX) for transmitting through Mote1 or Mote2 to Mote0',
                xaxis2 = dict(
